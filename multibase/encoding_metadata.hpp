...
class encoding_metadata {
 public:
  ...
  [[nodiscard]] constexpr encoding encoding() const;
  ...
  [[nodiscard]] constexpr encoding_case encoding_case() const;

 private:
  template <enum encoding t_encoding>
  constexpr void init() {
    encoding_ = {t_encoding}, name_ = {magic_enum::enum_name(t_encoding)},
    ...
    encoding_case_ = {encoding_traits<t_encoding>::encoding_case},
...
constexpr std::string_view encoding_metadata::alphabet() const { return alphabet_; }

constexpr encoding encoding_metadata::encoding() const { return encoding_; }

constexpr bool encoding_metadata::is_case_sensitive() const { return is_case_sensitive_; }

constexpr encoding_case encoding_metadata::encoding_case() const {
